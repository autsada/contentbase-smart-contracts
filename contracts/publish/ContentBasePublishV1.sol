    ...
    IContentBasePublishV1
{
        ...
        onlyProfileOwner(createPublishData.creatorId)
    {
        ...
        Helpers.notTooLongDescription(createPublishData.description);

        // Validate categories.
        Helpers.validPrimaryCategory(createPublishData.primaryCategory);
        Helpers.validCategory(createPublishData.secondaryCategory);
        Helpers.validCategory(createPublishData.tertiaryCategory);
        ...
        onlyTokenOwner(updatePublishData.tokenId)
    {
        ...
        // Validate description.
        Helpers.notTooLongDescription(updatePublishData.description);

        // Validate categories.
        Helpers.validPrimaryCategory(updatePublishData.primaryCategory);
        Helpers.validCategory(updatePublishData.secondaryCategory);
        Helpers.validCategory(updatePublishData.tertiaryCategory);
